...
export function FeaturedAllTopics({ topicId, desc }: FeaturedAllTopicsProps) {
  return (
    ...
    >
      <div>
        <div className="mb-2.5 inline-flex items-center gap-2 text-[12.5px] font-medium tracking-[0.12em] text-white/55 uppercase">
        ...
        <p className="mt-3.5 max-w-[520px] text-[15px] leading-relaxed text-white/65">
          {desc}
        </p>
      </div>

      <div className="flex flex-col items-stretch gap-[18px] lg:items-end">
        <div className="rounded-pill inline-flex h-[52px] items-center justify-center bg-white px-6 text-[16px] font-medium text-[#0a1733]">
          Начать микс →
        </div>
      </div>
    </Link>

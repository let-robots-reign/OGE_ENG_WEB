...
ALTER TABLE "audio_task" RENAME CONSTRAINT "audio_task_first_topicId_training_topic_id_fk" TO "audio_task_topicId_training_topic_id_fk";--> statement-breakpoint
...
SELECT setval(
  ...
  (SELECT MAX(id) FROM audio_task) IS NOT NULL
);
